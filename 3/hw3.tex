...
units per second. With a GREEN threshold at $-1.2$ units, it will only take $0.307$ seconds to 
decide GREEN without any action potentials.

Now with $k$ action potentials, each bringing us $\log_{10}(\ell_1 / \ell_0) = \log_{10}(10 $Hz$ /
1 $Hz$) = 1 $ units away from the lower decision threshold, it will take $
